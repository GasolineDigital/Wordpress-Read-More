...
class Wpgdrm_Admin{
	...
	public function wpgdrm_admin_menu() {
	     ...
	     */
		add_menu_page( 'Read More', 'Read More', 'manage_options', 'wpgdrm', '', $this->icon, 54 );
		$page_options  = add_submenu_page( 'wpgdrm', 'Options', 'Options', 'manage_options', $this->plugin_name, array( $this, 'display_plugin_setup_page' ) );
